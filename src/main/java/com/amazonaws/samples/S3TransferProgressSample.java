 ...
 * (/Users/animesh.badjatya/.aws/credentials) where the sample code will load
...
public class S3TransferProgressSample {
	...
	public static void main(String[] args) throws Exception {
		...
		AmazonS3 s3 = AmazonS3ClientBuilder.standard().withCredentials(credentialsProvider).withRegion("us-west-2")
				.build();
