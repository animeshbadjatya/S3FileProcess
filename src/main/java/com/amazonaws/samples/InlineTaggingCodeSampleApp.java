...
public class InlineTaggingCodeSampleApp {
	...
	public static void main(String[] args) {
		...
		// Create a variable that will track whether there are any requests still in the
		// open state.
		boolean anyOpen;
		...
		do {
			...
			// Initialize the anyOpen variable to false, which assumes there are no requests
			// open unless
